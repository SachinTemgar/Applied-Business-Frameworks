...
Real-world strategic analyses applying structured frameworks to complex business and technology problems.
...
Every analysis follows the same discipline:

| Principle | What It Means |
|---|---|
| **Define the real question** | Not the obvious one. The one underneath it. |
| **Apply structured frameworks** | SCOR, Lean, JTBD. Not because they're academic requirements, but because they force rigor. |
| **Quantify wherever possible** | A 36-point SCOR gap tells a sharper story than "Arizona is behind." |
| **Challenge the default narrative** | SpaceX isn't just "move fast and break things." Netflix's problem isn't bad games. TSMC's struggles aren't just execution issues. |
| **Deliver an actionable conclusion** | Not "more research is needed," but a clear position with supporting evidence. |

---

## About Me

I'm an MS Software Engineering student at Northeastern University building at the intersection of engineering, data, and strategy.

My technical work lives here: [github.com/SachinTemgar](https://github.com/SachinTemgar)

These analyses represent the other half: how I think about the *why* and *what* before the *how*.

---

*If your work involves turning complexity into clarity, let's talk.*
